...
public class TitleBuilder {
    ...
    public TitleBuilder send() {
        ...
        try {
            ...
            Constructor<?> titleConstructor = ReflectionUtil.getNMSClass("PacketPlayOutTitle")
                    .getConstructor(ReflectionUtil.getNMSClass("PacketPlayOutTitle").getDeclaredClasses()[0],
