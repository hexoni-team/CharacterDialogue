...
public class CharacterDialogueCommand implements CommandClass {
    ...
    private final YamlFile language;
    ...
    public void mainCommand(CommandSender sender) {
        sender.sendMessage(translateList(language.getStringList("help-message")).toArray(new String[0]));
    }
    ...
    private List<String> translateList(List<String> list) {
        ...
        list.forEach((line) -> newList.add(TextUtils.colorize(line)));
        return newList;
    }
